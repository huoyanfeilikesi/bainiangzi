...
#import "GuluGameSDK/GuluGameSDK.h"
...
- (BOOL)application:(UIApplication*)application didFinishLaunchingWithOptions:(NSDictionary*)launchOptions
{
    ...
    [TalkingDataAppCpa init:@"6DAFCC48F4ED4FB2B5FB988C90038702" withChannelId:@"AppStore"];
...
//  支付td
- (void)iospaytd:(NSString*) account order:(NSString*) orderid count:(int) amount
{
    NSLog(@"支付td: %@%@%d", account, orderid, amount);
    [TalkingDataAppCpa onPay:account withOrderId:orderid withAmount:amount withCurrencyType:@"CNY" withPayType:@"苹果内购"];
}
...
-(void)initsdk
{
    NSLog(@"初始化 init");
    //一般要在这里增加回调监听
    [MTSDK initWidthAppId:@"gldd1017"
                   appKey:@"53B9B38320AB4054B071A70689CBD0CA"
               appChannel:@"gulusdk_ios"
              gameVersion:@"1.4.0.0" delegate:self];
}
...
{
    NSLog(@"支付 json=%@", json);
    MTPayModel *payModel = [[MTPayModel alloc] init];
    payModel.product_id = @"gulugameSDKDemo2";
    payModel.region = @"server01";
    payModel.product_name = @"gulugameSDKDemo2";
    payModel.out_trade_no = @"asdfds91732941320";
    payModel.para = @"other";
    payModel.pname = @"SDK";
    payModel.amount = @"12";
    payModel.currency = @"CNY";
    [MTSDK pay:payModel];
}
