...
public class LHUserManagerProxy implements IUserManager {
    ...
    public void login(Activity paramActivity, Object paramObject)
    {
        ...
        SWGameSDK.getInstance().login(paramActivity,
                SDKTools.GetSdkProperty(paramActivity, "SHUNWANG_SiteID"),
                SDKTools.GetSdkProperty(paramActivity, "SHUNWANG_GameID"),
                SDKTools.GetSdkProperty(paramActivity, "SHUNWANG_MD5Key"),
                SDKTools.GetSdkProperty(paramActivity, "SHUNWANG_RSAKey"),
    ...
    public void logout(Activity paramActivity, Object paramObject) {
        SWGameSDK.getInstance().logout(paramActivity);
    }
