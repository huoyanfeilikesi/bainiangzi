...
public class LHExtendProxy
    ...
    public void enterUserCenter(final Activity paramActivity) {
        GameCenterSDK.getInstance().launchGameCenter(paramActivity);
    }

    //实名认证
    public void realNameRegister(final Activity paramActivity, final IHandleCallback callback) {
        OnRealNameRegister(paramActivity, callback);
    }

    public static void OnRealNameRegister(final Activity paramActivity, final IHandleCallback callback){
        LogUtil.d("实名制校验");
