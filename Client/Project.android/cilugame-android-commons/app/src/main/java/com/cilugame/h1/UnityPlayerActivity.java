...
import com.cilugame.h1.input.ViewManager;
...
public class UnityPlayerActivity extends Activity {
    ...
    private void startUnityPlayerActivity()
    {
        ...
        mUnityPlayer.addView(splashView);
    ...
    {
        String curVersion = AssetsUtils.getMetaData(ANDROID_DLL_VERSION);
...
//        Toast.makeText(instance, "删除DLL目录成功", Toast.LENGTH_SHORT).show();
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        Logger.Log("startUnity, loadUnityPlayer：" + String.valueOf(loadUnityPlayer));
       /* checkNewInstallation(); loadUnityPlayer = true;*/
