...
public class CLSDKPlugin {
    ...
    public static void Setup()
    {
        ...
        GameApi.getInstance().setUserListener(UnityPlayerActivity.instance,
                new IUserListener() {
                    public void onSwitchAccount(int arg0, LHUser lhUser){
                        switch (arg0){
                            case LHStatusCode.LH_SWITCH_ACCOUNT_SUCCESS:
                                LHUser loginUser = lhUser;
                                ...
                                try{
                                    ...
                                    if(loginUser.getLoginMsg() != null){
                                        jsonObject.put("loginMsg", loginUser.getLoginMsg());
                                    }
                                }catch(Exception e){
                                    e.printStackTrace();
                                ...
                                UnityCallbackWrapper.OnSwitchAccount(true, jsonObject.toString());
                                break;
                            default:
                                UnityCallbackWrapper.OnSwitchAccount(false, "");
                                break;
                        }
                    }
 ...
 */
    public static void SwitchAccount() {
        Logger.Log("Call SwitchAccount");
        GameApi.gameApi.switchAccount(UnityPlayerActivity.instance, "switchAccount");
    }
    ...
    public static void SubmitRoleData(String roleJsonStr) {
        ...
        try {
            ...
            lhRole.setExtendMsg(roleJson.getString("extendMsg"));
...
//        //TSIDataSDK.getInstance().regster(account, uid);
    ...
    public static void UnityInitFinish(){
        Logger.Log("Call UnityInitFinish = "+ (UnityPlayerActivity.instance != null));
        //移除自绘闪屏
