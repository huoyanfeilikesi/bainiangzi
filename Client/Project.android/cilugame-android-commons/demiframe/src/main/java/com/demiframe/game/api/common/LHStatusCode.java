...
public class LHStatusCode
{
    ...
    public static final int LH_SWITCH_ACCOUNT_SUCCESS = 23;
    public static final int LH_SWITCH_ACCOUNT_FAIL = 24;
    public static final int LH_SWITCH_ACCOUNT_CANCEL = 25;
}
