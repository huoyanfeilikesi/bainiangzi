...
public class LHUserManagerProxy
    ...
    public void login(Activity paramActivity, Object paramObject) {
        ...
        Matrix.execute(paramActivity, intent, callback);
    ...
    public void logout(final Activity paramActivity, Object paramObject) {
        ...
        Matrix.execute(paramActivity, intent, new IDispatcherCallback() {
            @Override
    ...
    public void updateUserInfo(Activity paramActivity, LHUser paramLHUser) {
        User.getInstances().setUserInfo(paramLHUser);
    }
}