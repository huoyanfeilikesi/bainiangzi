...
//    }
    ...
    public void antiAddictionQuery(final Activity activity, IHandleCallback paramIHandleCallback) {
    }
    ...
    public void realNameRegister(final Activity activity, IHandleCallback paramIHandleCallback) {
    }

    public void submitRoleData(final Activity activity, LHRole lhRole) {
//        LHExtendProxy.setLastRoleData(lhRole);
        LHExtendProxy.doSubmitRoleData(activity, lhRole);
    }
...
//    }
    ...
    public static void doSubmitRoleData(Activity activity, LHRole lhRole){
        ...
        else if(lhRole.getDataType() == LHRoleDataType.exitServer){
