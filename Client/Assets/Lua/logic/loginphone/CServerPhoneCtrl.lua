...
CServerPhoneCtrl.g_DevServer = {
	servers = {
		...
		-- 内服
		[1001]={id=1001, name="车库源码", ip="47.104.160.97", new=1, serverindex=9999-1001},
...
CServerPhoneCtrl.g_ReleaseServer = {
	servers ={
		[2001]={id=2001,name="开发服",ip="devh7.cilugame.com",new=1,serverindex=100}
	},
	common_port = {7011,7012,27011,27012,27013},
}
CServerPhoneCtrl.g_YunceServer = {
	servers ={
		[3001]={id = 3001, name="云测服", ip="120.132.11.112",new=0, serverindex = 100}
	},
	common_port = {7011,7012,27011,27012,27013},
}
