...
public class UnityEngine_LightWrap
{
	...
	static int AddCommandBuffer(IntPtr L)
	{
		try
		{
			...
			UnityEngine.Rendering.LightEvent arg0 = (UnityEngine.Rendering.LightEvent)(int)LuaDLL.lua_tonumber(L, 2);
	...
	static int GetLights(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 2);
			UnityEngine.LightType arg0 = (UnityEngine.LightType)(int)LuaDLL.lua_tonumber(L, 1);
	...
	static int set_type(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Light obj = (UnityEngine.Light)o;
			UnityEngine.LightType arg0 = (UnityEngine.LightType)(int)LuaDLL.lua_tonumber(L, 2);
			obj.type = arg0;
			return 0;
		}
		catch(Exception e)
	...
	static int set_shadows(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Light obj = (UnityEngine.Light)o;
			UnityEngine.LightShadows arg0 = (UnityEngine.LightShadows)(int)LuaDLL.lua_tonumber(L, 2);
			obj.shadows = arg0;
			return 0;
		}
		catch(Exception e)
	...
	static int set_renderMode(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Light obj = (UnityEngine.Light)o;
			UnityEngine.LightRenderMode arg0 = (UnityEngine.LightRenderMode)(int)LuaDLL.lua_tonumber(L, 2);
			obj.renderMode = arg0;
			return 0;
		}
		catch(Exception e)
