...
public class UnityEngine_MeshWrap
{
	...
	static int SetIndices(IntPtr L)
	{
		try
		{
			...
			if (count == 4 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Mesh), typeof(int[]), typeof(int), typeof(int)))
			{
				UnityEngine.Mesh obj = (UnityEngine.Mesh)ToLua.ToObject(L, 1);
				int[] arg0 = ToLua.CheckNumberArray<int>(L, 2);
				UnityEngine.MeshTopology arg1 = (UnityEngine.MeshTopology)(int)LuaDLL.lua_tonumber(L, 3);
				int arg2 = (int)LuaDLL.lua_tonumber(L, 4);
				obj.SetIndices(arg0, arg1, arg2);
				return 0;
			}
			else if (count == 5 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Mesh), typeof(int[]), typeof(int), typeof(int), typeof(bool)))
			{
				UnityEngine.Mesh obj = (UnityEngine.Mesh)ToLua.ToObject(L, 1);
				int[] arg0 = ToLua.CheckNumberArray<int>(L, 2);
				UnityEngine.MeshTopology arg1 = (UnityEngine.MeshTopology)(int)LuaDLL.lua_tonumber(L, 3);
